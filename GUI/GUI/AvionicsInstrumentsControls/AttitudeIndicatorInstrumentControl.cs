...
namespace AvionicsInstrumentControlDemo
{
    class AttitudeIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(GUI.Properties.Resources.Horizon_Background);
        Bitmap bmpBoule = new Bitmap(GUI.Properties.Resources.Horizon_GroundSky);
        Bitmap bmpAvion = new Bitmap(GUI.Properties.Resources.Maquette_Avion);
