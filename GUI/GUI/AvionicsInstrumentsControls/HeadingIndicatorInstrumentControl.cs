...
namespace AvionicsInstrumentControlDemo
{
    class HeadingIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(GUI.Properties.Resources.HeadingIndicator_Background);
        Bitmap bmpHedingWeel = new Bitmap(GUI.Properties.Resources.HeadingWeel);
        Bitmap bmpAircaft = new Bitmap(GUI.Properties.Resources.HeadingIndicator_Aircraft);        
